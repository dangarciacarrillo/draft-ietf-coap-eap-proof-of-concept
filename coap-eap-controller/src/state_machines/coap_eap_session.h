 ...
 * @brief Headers of functions to manage CoAP-EAP sessions.
 **/
/*
...
/** Initializes the pana_ctx structure refered to a new CoAP-EAP session.
 *
 * @param *coap_eap_session Session that gonna be initialized*/
