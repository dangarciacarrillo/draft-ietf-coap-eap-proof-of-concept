 ...
 *
 * Version:	$Id: radclient.c,v 1.118 2007/12/17 12:30:42 aland Exp $
 *
...
RCSID("$Id: radclient.c,v 1.118 2007/12/17 12:30:42 aland Exp $")
...
int main(int argc, char **argv)
{
	...
	while ((c = getopt(argc, argv, "46c:d:f:Fhi:n:p:qr:sS:t:vx")) != EOF) switch(c) {
		...
		case 't':
			...
			break;
		case 'v':
			printf("radclient: $Id: radclient.c,v 1.118 2007/12/17 12:30:42 aland Exp $ built on " __DATE__ " at " __TIME__ "\n");
			exit(0);
			break;
		case 'x':
			librad_debug++;
