 ...
 *
 * Version:     $Id: rlm_dbm_parser.c,v 1.17 2007/11/23 13:46:56 aland Exp $
 *
...
char sccsid[] =
"$Id: rlm_dbm_parser.c,v 1.17 2007/11/23 13:46:56 aland Exp $ sandy module project\n Copyright 2001 Sandy Service\nCopyright 2001 Koulik Andrei";
	...
	while ((ch = getopt(n, argv, "d:i:xo:qvc")) != -1)
	 	switch (ch) {
			...
			case 'q':
				...
				break;
			case 'v':
				printf("%s: $Id: rlm_dbm_parser.c,v 1.17 2007/11/23 13:46:56 aland Exp $ \n",progname);
				exit(0);
			case 'c':
