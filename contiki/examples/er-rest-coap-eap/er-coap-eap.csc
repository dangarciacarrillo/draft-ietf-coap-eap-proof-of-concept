...
<simconf>
  ...
  <simulation>
    ...
    <motetype>
      ...
      <description>CoAP-EAP IoT device</description>
      <source EXPORT="discard">[CONTIKI_DIR]/examples/er-rest-coap-eap/er-coap-eap.c</source>
      <commands EXPORT="discard">make er-coap-eap.exp5438 TARGET=exp5438</commands>
      <firmware EXPORT="copy">[CONTIKI_DIR]/examples/er-rest-coap-eap/er-coap-eap.exp5438</firmware>
      <moteinterface>se.sics.cooja.interfaces.Position</moteinterface>
      <moteinterface>se.sics.cooja.interfaces.RimeAddress</moteinterface>
      <moteinterface>se.sics.cooja.interfaces.IPAddress</moteinterface>
      <moteinterface>se.sics.cooja.interfaces.Mote2MoteRelations</moteinterface>
    ...
    <mote>
      ...
      <interface_config>
        ...
        <x>69.20059596275294</x>
        <y>14.276158075455374</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
    ...
    <mote>
      ...
      <interface_config>
        se.sics.cooja.interfaces.Position
        <x>90.98973981368496</x>
        <y>0.42498385699676344</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
        se.sics.cooja.mspmote.interfaces.MspMoteID
  ...
  <plugin>
    ...
    <plugin_config>
      ...
      <viewport>10.572404218341164 0.0 0.0 10.572404218341164 -641.6166726683318 103.06668614135035</viewport>
    </plugin_config>
    <width>400</width>
    <z>1</z>
    <height>400</height>
